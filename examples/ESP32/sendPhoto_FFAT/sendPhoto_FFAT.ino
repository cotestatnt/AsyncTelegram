...
const char* token =  "xxxxxxxxxxxx"; // REPLACE myToken WITH YOUR TELEGRAM BOT TOKEN
  ...
  if (myBot.getNewMessage(msg)) {        
    ...
    if (msgType == MessageText){
      ...
      if (msgText.equalsIgnoreCase("/photofs1")) {
        ...
        myBot.sendPhotoByFile(msg, myFile, FFat);                    
      }
        ...
        Serial.println(url);          
        myBot.sendPhotoByFile(msg, fileName, FFat);
